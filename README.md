...
every channel whose updates in either direction (re)started after the given timestamp, having never
been seen before or having been absent for at least the prune interval, is collected alongside its
announcement.
